...
def index():
    ...
    if request.method == "POST":
        ...
        original_image = cv2.imrea(os.path.join(app.config['EXISTING_FILE'], 'image.jpg'))
        ...
        cv2.imwrite(os.path.join(app.config['GENERATED_FILE'], 'image_uploaded.jps'), uploaded_image)
